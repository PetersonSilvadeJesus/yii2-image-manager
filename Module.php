...
namespace petersonsilvadejesus\imagemanager;
...
class Module extends \yii\base\Module {
	...
	public function init() {
		...
		//set asset path
		$this->assetPublishedUrl = (new AssetManager)->getPublishedUrl("@vendor/petersonsilvadejesus/yii2-image-manager/assets/source");
