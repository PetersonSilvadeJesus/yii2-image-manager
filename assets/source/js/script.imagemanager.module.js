var imageManagerModule = {
	...
	selectImage: function(id){
		//set selected class
		$("#module-imagemanager .item-overview .item .card").removeClass("border-primary");
		$("#module-imagemanager .item-overview .item[data-key='"+id+"'] .card").addClass("border-primary");
		//get details
	...
	pickImage: function(){
		...
		switch(imageManagerModule.selectType){
			...
			case "input":
				...
				$('#'+sFieldImageId, window.parent.document).attr("src",imageManagerModule.selectedImage.image).parents('div').removeClass("d-none");
				//trigger change
