...
namespace petersonsilvadejesus\imagemanager\components;
...
use yii\helpers\Url;
use petersonsilvadejesus\imagemanager\models\ImageManager;
use petersonsilvadejesus\imagemanager\assets\ImageManagerInputAsset;
...
class ImageManagerInputWidget extends InputWidget
{
    ...
    public function init()
    {
        ...
        if (!isset(Yii::$app->i18n->translations['imagemanager'])) {
            Yii::$app->i18n->translations['imagemanager'] = [
                ...
                'sourceLanguage' => 'en',
                'basePath' => '@petersonsilvadejesus/imagemanager/messages'
            ];
        }
    }
    ...
    public function run()
    {
        ...
        $field .= "<a href='#' class='btn btn-danger delete-selected-image " . $sHideClass . "' data-input-id='" . $sFieldId . "' data-show-delete-confirm='" . ($this->showDeletePickedImageConfirm ? "true" : "false") . "'><i class='fas fa-trash' aria-hidden='true'></i></a>";
        $field .= "<a href='#' class='btn btn-primary open-modal-imagemanager' data-aspect-ratio='" . $this->aspectRatio . "' data-crop-view-mode='" . $this->cropViewMode . "' data-input-id='" . $sFieldId . "'>";
        $field .= "<i class='fas fa-folder-open' aria-hidden='true'></i>";
        $field .= "</a></div>";
        ...
        if ($this->showPreview == true) {
            ...
            $field .= '<div class="image-wrapper ' . $sHideClass . '">'
                . '<img id="' . $sFieldId . '_image" alt="Thumbnail" class="img-fluid img-preview" src="' . $sImageSource . '">'
                . '</div>';
        }
