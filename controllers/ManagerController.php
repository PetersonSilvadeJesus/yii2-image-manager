...
namespace petersonsilvadejesus\imagemanager\controllers;

use Yii;
use petersonsilvadejesus\imagemanager\models\ImageManager;
use petersonsilvadejesus\imagemanager\models\ImageManagerSearch;
use petersonsilvadejesus\imagemanager\assets\ImageManagerModuleAsset;
...
use petersonsilvadejesus\imagemanager\Module;
...
class ManagerController extends Controller
{
    ...
    public function behaviors()
    {
        ...
        if (Yii::$app->modules['imagemanager']->login === true) {
