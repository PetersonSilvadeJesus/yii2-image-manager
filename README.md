...
```
php composer.phar require "petersonsilvadejesus/yii2-image-manager" "*" 
```
or add
...
```
yii migrate --migrationPath=@petersonsilvadejesus/imagemanager/migrations
```
...
```
![Image manager module](/docs/images/img_doc-image-manager.png)
![Image manager module cropper](/docs/images/img_doc-image-manager-crop.png)
...
```php
echo $form->field($model, 'ImageManager_id_avatar')->widget(\petersonsilva\imagemanager\components\ImageManagerInputWidget::class, [
...
```
![Image widget](/docs/images/img_doc-image-widget.png)
![Image widget popup](/docs/images/img_doc-image-widget-popup.png)
